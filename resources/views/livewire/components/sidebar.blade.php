<div class="bg-gray-800 h-screen w-64 fixed left-0 top-0 shadow-lg flex flex-col">
    ...
    <nav class="flex-1 py-4">
        ...
        <a href="/admin/manage-users" wire:navigate class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition rounded-lg mx-2 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
